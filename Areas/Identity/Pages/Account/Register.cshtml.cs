...
namespace WebApplication2.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        //private readonly RoleManager<UsingIdentityUser> _rolemanger;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new UsingIdentityUser { UserName = Input.Email, Email = Input.Email,Firstname =Input.FirstName,LastName=Input.LastName,PhoneNumber=Input.PhoneNumber,EmailConfirmed=true};
